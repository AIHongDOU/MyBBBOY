...
from speech_to_speech.arguments_classes.edgetts_tts_arguments import EdgeTTSHandlerArguments
...
class ParsedArguments:
    ...
    edge_tts_handler_kwargs: EdgeTTSHandlerArguments
...
def parse_arguments() -> ParsedArguments:
    ...
    args = ParsedArguments(
        ...
        edge_tts_handler_kwargs=by_type[EdgeTTSHandlerArguments],
...
def prepare_all_args(
    ...
    rename_args(edge_tts_handler_kwargs, "edge_tts")
...
def _build_realtime_pipeline_unit(
    *,
    ...
    edge_tts_kw = deepcopy(edge_tts_handler_kwargs)
    ...
    handlers = _build_pipeline_handlers(
        ...
        edge_tts_handler_kwargs=edge_tts_kw,
    ...
    if module_kwargs.mode == "local":
        ...
        pool = [
            _build_realtime_pipeline_unit(
                ...
                edge_tts_handler_kwargs=edge_tts_handler_kwargs,
...
def get_tts_handler(
    ...
    if module_kwargs.tts == "chatTTS":
    ...
    elif module_kwargs.tts == "edgetts":
        from speech_to_speech.TTS.edgetts_handler import EdgeTTSHandler
        ...
        return EdgeTTSHandler(
            ...
            queue_out=send_audio_chunks_queue,
            setup_args=(should_listen,),
            setup_kwargs=vars(edge_tts_handler_kwargs),
        )
        ...
        raise ValueError("The TTS should be either chatTTS, facebookMMS, edgetts, pocket, kokoro, or qwen3")
