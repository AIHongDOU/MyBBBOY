...
class ModuleArguments:
    ...
    tts: Optional[Literal["chatTTS", "facebookMMS", "edgetts", "pocket", "kokoro", "qwen3"]] = field(
        default="qwen3",
        metadata={
            "help": "The TTS to use. Either 'chatTTS', 'facebookMMS', 'edgetts', 'pocket', 'kokoro', or 'qwen3'. Default is 'qwen3'."
        },
    )
    log_level: str = field(
        default="info",
